  ...
  implements ScheduledAction
{
  public void onTime(ScheduledActionContext arg0)
  {
    ...
    try
    {
      ...
      System.out.println("Finalizou o cadastro dos fornecedores empresa 4");
    }
    catch (Exception e)
    {
      e.printStackTrace();
    ...
    throws Exception
  {
    ...
    try
    {
      for (;;)
      {
        ...
        cadastrarFornecedor(responseString, codEmp);
        pagina++;
      }
    }
    catch (Exception e)
  ...
  public void cadastrarFornecedor(String responseString, BigDecimal codEmp)
  {
    ...
    try
    {
      ...
      for (JsonElement jsonElement : jsonArray)
      {
        ...
        {
          boolean fornecedor = getIfFornecedorExist(fornecedorCpfcnpj);
          if (fornecedor)
          {
            BigDecimal credotAtual = insertFornecedor(fornecedorTipo, 
              fornecedorId, fornecedorNome, 
              fornecedorNomeFantasia, fornecedorEndereco, 
              fornecedorBairro, fornecedorCidade, fornecedorUf, 
              fornecedorCep, fornecedorInscMunicipal, 
              fornecedorCpfcnpj, fornecedorHomepage, 
              fornecedorAtivo, dataAtualizacao, 
              fornecedorInscestadual, fornecedorFone1, 
              fornecedorFone2, fornecedorFax, fornecedorCelular, 
              fornecedorContato, fornecedorNome, fornecedorEmail, codEmp);
            
            insertLogIntegracao("Fornecedor Cadastrado: ", "Sucesso", 
              fornecedorNome);
          }
          else
          {
        	  boolean IdFornecedor = getIfIdFornecedorExist(fornecedorCpfcnpj, fornecedorId, codEmp);
        	  
        	  if(IdFornecedor){
        		  insertIdForn(fornecedorId, fornecedorCpfcnpj, codEmp); 
        	  }
        	  
        	  //updateIdForn(fornecedorId.trim(), fornecedorCpfcnpj.trim());
        	  
            /*insertLogIntegracao("Fornecedor já Cadastrado no Sistema: ", "Aviso", 
              fornecedorNome);*/
          }
          count++;
        }
  ...
  public boolean getIfIdFornecedorExist(String fornecedorCpfcnpj, String idAcad, BigDecimal codemp)
		  throws Exception
  {
	  EntityFacade entityFacade = EntityFacadeFactory.getDWFFacade();
	  JdbcWrapper jdbc = entityFacade.getJdbcWrapper();
	  ...
	  try
	  {
		  ...
		  String sqlSlt = "SELECT COUNT(0) AS C FROM AD_IDFORNACAD WHERE CODPARC = (SELECT CODPARC FROM TGFPAR WHERE CGC_CPF = '"+fornecedorCpfcnpj+"') AND IDACADWEB = '"+idAcad+"' AND CODEMP = " + codemp;
  ...
  public BigDecimal insertFornecedor(String fornecedorTipo, String fornecedorId, String fornecedorNome, String fornecedorNomeFantasia, String fornecedorEndereco, String fornecedorBairro, String fornecedorCidade, String fornecedorUf, String fornecedorCep, String fornecedorInscMunicipal, String fornecedorCpfcnpj, String fornecedorHomepage, String fornecedorAtivo, String dataAtualizacao, String fornecedorInscestadual, String fornecedorFone1, String fornecedorFone2, String fornecedorFax, String fornecedorCelular, String fornecedorContato, String fornecedorNome2, String fornecedorEmail, BigDecimal codEmp)
    throws Exception
  {
    EntityFacade entityFacade = EntityFacadeFactory.getDWFFacade();
    JdbcWrapper jdbc = entityFacade.getJdbcWrapper();
    ...
    try
    {
      ...
      if ((fornecedorFone1 != null) && (fornecedorFone2 != null) && 
        ...
        insertContatoFornecedor(fornecedorFone1, fornecedorFone2, 
          ...
          fornecedorContato, fornecedorNome, fornecedorEmail, atualCodparc);
      } else {
        insertLogIntegracao(
          "Uma ou mais variáveis são nulas, a função de cadastrar contato não será chamada.", "Aviso", 
          fornecedorNome);
      }
  ...
  public void updateIdForn(String idForn, String cgc)
		  throws Exception
  {
	  EntityFacade entityFacade = EntityFacadeFactory.getDWFFacade();
	  JdbcWrapper jdbc = entityFacade.getJdbcWrapper();
	  ...
	  try
	  {
		  ...
		  String sqlP = "UPDATE TGFPAR SET AD_ID_EXTERNO_FORN = '"+idForn+"' WHERE CODPARC = (SELECT CODPARC FROM TGFPAR WHERE CGC_CPF = '"+cgc+"')";
		  ...
		  throws Exception
  {
	  ...
	  try
	  {
		  ...
		  String sqlP = "INSERT INTO AD_IDFORNACAD (CODPARC, ID, IDACADWEB, CODEMP) VALUES ((SELECT CODPARC FROM TGFPAR WHERE CGC_CPF = '"+cgc+"'), (SELECT NVL(MAX(ID), 0) + 1 FROM AD_IDFORNACAD), '"+idForn+"', "+codemp+")";
  ...
  private void insertContatoFornecedor(String fornecedorFone1, String fornecedorFone2, String fornecedorFax, String fornecedorCelular, String fornecedorContato, String fornecedorNome, String fornecedorEmail, BigDecimal credotAtual)
    throws Exception
  {
    EntityFacade entityFacade = EntityFacadeFactory.getDWFFacade();
    JdbcWrapper jdbc = entityFacade.getJdbcWrapper();
  ...
  public void insertLogIntegracao(String descricao, String status, String fornecedorNome)
    throws Exception
  {
    EntityFacade entityFacade = EntityFacadeFactory.getDWFFacade();
    JdbcWrapper jdbc = entityFacade.getJdbcWrapper();
    ...
    try
    {
      ...
      if (fornecedorNome.equals("")) {
        ...
        descricaoCompleta = 
          descricao + " " + " Fornecedor:" + fornecedorNome;
      } else if (!fornecedorNome.isEmpty()) {
        descricaoCompleta = 
          descricao + " " + " Fornecedor:" + fornecedorNome;
      }
  ...
  public String[] apiGet(String ur, String token)
    throws Exception
  {
