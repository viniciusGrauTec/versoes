...
public class AcaoGetBaixaTiposFornecedoresCarga implements AcaoRotinaJava, ScheduledAction {
	...
	public void onTime(ScheduledActionContext arg0) {
		...
		try {
			...
			while (rs.next()) {
				...
				System.out.println("ENTROU NO OnTime DA  AcaoGetBaixaTiposFornecedoresCarga! ");
				
				selecionarTiposFornecedores(jdbc,url, token, codEmp, mapaInfTipoTituloTaxa, mapaInfBanco,
	...
	//NOVO METODO AUXILIAR AQUI
		public void selecionarTiposFornecedores(JdbcWrapper jdbc, String url, String token, BigDecimal codEmp,
				...
				Map<BigDecimal, BigDecimal> mapaInfFinanceiroBanco)
	 {
			...
			try {
				...
				while (rs.next()) {
					...
					System.out.println("ENTROU NO METODO DA  AcaoGetBaixaTiposFornecedoresCarga! ");
