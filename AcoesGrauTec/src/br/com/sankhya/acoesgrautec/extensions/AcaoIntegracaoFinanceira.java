...
public class AcaoIntegracaoFinanceira implements AcaoRotinaJava {
	...
	public void doAction(ContextoAcao contexto) throws Exception {
		...
		ResultSet rs = null;
		 ...
		 String dtIni = Optional.ofNullable(contexto.getParam("DTINICIO"))
		            .orElseThrow(() -> new Exception("Parâmetro DTINICIO não fornecido"))
		            .toString();
		    
		    String dtFin = Optional.ofNullable(contexto.getParam("DTFIM"))
		            .orElseThrow(() -> new Exception("Parâmetro DTFIN não fornecido"))
		            .toString();
	...
	public void cadastrarFinanceiro(String url, String token, BigDecimal codemp, String DateFIni, String DateFFin)
		...
		try {
			...
			while (rs.next()) {
				 ...
				 * "	    \"titulo_ano_ref\": \"2023\", " +
				 * "	    \"titulo_situacao\": \"B\", " +
				 * "	    \"titulo_observa��o\": \"Aluno indicou o amigo\",  " +
				 * "	    \"taxa_id\": \"10587\", " +
				...
				if (responseStatus.equalsIgnoreCase("200")) {
					...
					for (JsonElement jsonElement : jsonArray) {
						...
						// Para os benef�cios, voc� pode fazer um loop interno
						/*
						 ...
						 * System.out.println("Beneficio Descri��o: " +
	...
	public BigDecimal insertFin(BigDecimal codemp, BigDecimal codCenCus,
		...
		try {
			...
			//final BigDecimal USUARIO_PADRAO = BigDecimal.valueOf(409);  // 409 aqui
