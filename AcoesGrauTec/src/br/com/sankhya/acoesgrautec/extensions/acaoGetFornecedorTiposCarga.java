...
public class acaoGetFornecedorTiposCarga
			...
			if(status.equalsIgnoreCase("200")){
				...
				for (JsonElement jsonElement : jsonArray) {
					...
					if ((fornecedorCpfcnpj != null) && (fornecedorAtivo != null)
						...
						System.out.println("Valida��o parceiro: " + fornecedor);
						...
						if (fornecedor) {
							...
							System.out.println("Valida��o id fornecedor: " + IdFornecedor);
						...
						selectsParaInsert.add("SELECT <#NUMUNICO#>, 'Fornecedor N�o Ser� Cadastrado, Informa��es Nulas ou invalidas', SYSDATE, 'Aviso', "+codEmp+", '"+fornecedorId+"' FROM DUAL");
	...
	public BigDecimal insertFornecedor(String fornecedorTipo,
		...
		try {
			...
			if ((fornecedorFone1 != null) && (fornecedorFone2 != null)
				...
				selectsParaInsert.add("SELECT <#NUMUNICO#>, 'Uma ou mais vari�veis s�o nulas, a fun��o de cadastrar contato n�o ser� chamada.', SYSDATE, 'Aviso', "+codEmp+", '"+fornecedorId+"' FROM DUAL");
